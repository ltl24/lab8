...
var addressSchema = mongoose.Schema({ //Defines the Schema for this database
  Name: String,
  Address: String
});

var Comment = mongoose.model('Comment', commentSchema); //Makes an object from that schema as a model
var Address = mongoose.model('Address', addressSchema); //Makes an object from that schema as a model
